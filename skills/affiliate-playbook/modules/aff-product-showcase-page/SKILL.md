...
- "Built with Affiliate Skills by Affitor" footer from `../aff-shared-references/affitor-branding.md`
...
- `../aff-shared-references/ftc-compliance.md` — Disclosure text for hero and footer. Read in Step 3.
- `../aff-shared-references/affitor-branding.md` — Footer attribution HTML. Read in Step 3.
