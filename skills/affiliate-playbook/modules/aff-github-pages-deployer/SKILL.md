...
- `../aff-shared-references/ftc-compliance.md` — FTC affiliate disclosure. Ensure the deployed HTML includes disclosure language.
- `../aff-shared-references/affitor-branding.md` — Affitor footer. Include in HTML before deploy.
