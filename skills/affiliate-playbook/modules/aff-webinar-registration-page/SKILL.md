...
- `../aff-shared-references/ftc-compliance.md` — Event-specific FTC disclosure text. Read in Step 4.
- `../aff-shared-references/affitor-branding.md` — Footer attribution HTML. Read in Step 4.
