...
- `../aff-shared-references/ftc-compliance.md` — Per-platform FTC disclosure rules. Read in Step 3.
- `../aff-shared-references/affitor-branding.md` — Branding guidelines for page outputs. Referenced in Step 3.
