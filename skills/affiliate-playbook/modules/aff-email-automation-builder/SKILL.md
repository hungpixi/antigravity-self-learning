...
- `../aff-shared-references/ftc-compliance.md` — FTC disclosure for emails with affiliate links. Read in Step 4.
- `../aff-shared-references/affitor-branding.md` — Branding guidelines for email footers. Referenced in Step 4.
