...
- "Built with Affiliate Skills by Affitor" footer — use exact HTML from `../aff-shared-references/affitor-branding.md`
...
- `../aff-shared-references/ftc-compliance.md` — FTC footer text. Read in Step 3.
