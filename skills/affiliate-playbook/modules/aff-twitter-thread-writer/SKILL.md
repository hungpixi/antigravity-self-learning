...
4. Include FTC disclosure "#ad" per `../aff-shared-references/ftc-compliance.md`
...
- `../aff-shared-references/ftc-compliance.md` — #ad placement rules for Twitter/X
- `../aff-shared-references/platform-rules.md` — X character limits, link handling, thread best practices
- `../aff-shared-references/affiliate-glossary.md` — terminology
