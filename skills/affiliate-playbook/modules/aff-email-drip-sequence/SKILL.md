...
- `../aff-shared-references/ftc-compliance.md` — FTC affiliate disclosure requirements. Apply to every email containing an affiliate link.
- `../aff-shared-references/affitor-branding.md` — Affitor footer. Include in plain text footer of each email.
