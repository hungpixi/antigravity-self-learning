...
Per `../aff-shared-references/ftc-compliance.md` for short-form video:
...
- `../aff-shared-references/ftc-compliance.md` — disclosure rules for short-form video
- `../aff-shared-references/affiliate-glossary.md` — reward_type and program terminology
- `../aff-shared-references/platform-rules.md` — TikTok/Reels/Shorts format specs
