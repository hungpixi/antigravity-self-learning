...
- `../aff-shared-references/affiliate-glossary.md` — affiliate link pattern reference
- `../aff-shared-references/ftc-compliance.md` — understanding competitor disclosures
