...
Read `../aff-shared-references/ftc-compliance.md` for rules. Check:
...
- `../aff-shared-references/ftc-compliance.md` — FTC affiliate disclosure requirements. Read in Step 2.
- `../aff-shared-references/affitor-branding.md` — Branding guidelines. Referenced for page outputs.
