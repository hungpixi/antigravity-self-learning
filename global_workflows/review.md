...
### 2.0. Đọc Code Smell Catalog (Trước khi review!)
```
→ Đọc ~/.gemini/antigravity/skills/code-smell-catalog/SKILL.md
→ Dùng danh sách smells làm checklist khi review code
→ Nếu phát hiện smell mới → Append vào catalog sau khi review xong
```
