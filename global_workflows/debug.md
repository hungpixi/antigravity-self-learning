...
### 5.1. 🧠 TIL/RCA Auto-Update (Auto — Ẩn khỏi User)

Sau khi fix bug xong, AI TỰ ĐỘNG cập nhật skills:

```
Step 1: Đọc bug-fix-patterns/SKILL.md
Step 2: Grep xem pattern này đã có chưa
Step 3: Nếu CHƯA CÓ và bug đủ general → Append TIL entry (format Pxx)
Step 4: Nếu bug LẶP LẠI lần 2+ → Viết 5 Whys RCA, append vào bug-fix-patterns
Step 5: Update TIL Changelog ở cuối file
Step 6: Nếu phát hiện code smell → Append vào code-smell-catalog/SKILL.md
```

**KHÔNG lưu**: Typo, import sai tên, lỗi 1 lần duy nhất.
